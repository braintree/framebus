...
=======
"use strict";!function(n,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define([],t):n.framebus=t()}(this,function(){function n(n){n instanceof Window&&l.push(n)}function t(n,t,e){var r;return e=e||"*","string"!=typeof n?!1:"string"!=typeof e?!1:(r=o(n,t,e),r===!1?!1:(c(d.top,r,e),!0))}function e(n,t,e){return e=e||"*",p(n,t,e)?!1:(v[e]=v[e]||{},v[e][n]=v[e][n]||[],v[e][n].push(t),!0)}function r(n,t,e){var r,o;if(e=e||"*",p(n,t,e))return!1;if(o=v[e]&&v[e][n],!o)return!1;for(r=0;r<o.length;r++)if(o[r]===t)return o.splice(r,1),!0;return!1}function o(n,t,e){var r=!1,o={event:n,origin:e};"function"==typeof t?o.reply=g(t,e):o.data=t;try{r=y+JSON.stringify(o)}catch(i){throw new Error("Could not stringify event: "+i.message)}return r}function i(n){var t,e,r;if(n.data.slice(0,y.length)!==y)return!1;try{t=JSON.parse(n.data.slice(y.length))}catch(i){return!1}return null!=t.reply&&(e=n.origin,r=n.source,t.data=function(n){var i=o(t.reply,n,e);return i===!1?!1:(r.postMessage(i,e),void 0)}),t}function u(n){d||(d=n||window,d.addEventListener?d.addEventListener("message",a,!1):d.attachEvent?d.attachEvent("onmessage",a):null===d.onmessage?d.onmessage=a:d=null)}function f(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(n){var t=16*Math.random()|0,e="x"===n?t:3&t|8;return e.toString(16)})}function a(n){var t;"string"==typeof n.data&&(t=i(n),t&&(s("*",t.event,t.data,n.origin),s(n.origin,t.event,t.data,n.origin),x(n.data,t.origin)))}function s(n,t,e,r){var o;if(v[n]&&v[n][t])for(o=0;o<v[n][t].length;o++)v[n][t][o](e,r)}function c(n,t,e){var r;for(n.postMessage(t,e),n.opener&&n.opener!==d&&c(n.opener.top,t,e),r=0;r<n.frames.length;r++)c(n.frames[r],t,e);x(t,e)}function x(n,t){var e,r;for(e=l.length-1;e>=0;e--)r=l[e],r.closed===!0?l=l.slice(e,1):c(r.top,n,t)}function g(n,t){function o(e,u){n(e,u),r(i,o,t)}var i=f();return e(i,o,t),i}function p(n,t,e){return"string"!=typeof n?!0:"function"!=typeof t?!0:"string"!=typeof e?!0:!1}var d,l=[],v={},y="/*framebus*/";return u(),{include:n,publish:t,pub:t,trigger:t,emit:t,subscribe:e,sub:e,on:e,unsubscribe:r,unsub:r,off:r}});
