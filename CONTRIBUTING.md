...
2. **Skip the test** using `.skip` and add a comment referencing the tracking issue:
   ...
   ```javascript
   // Quarantined: flaky due to timing sensitivity (https://github.com/braintree/framebus/issues/123)
   ...
   ```javascript
   // Quarantined: intermittent failures under load (https://github.com/braintree/framebus/issues/123)
